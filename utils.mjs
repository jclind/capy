 ...
 * @param {Number} [radius = 5] The corner radius; It can also be an object to
 *                 specify different radii for corners
 ...
 *
 * Source: https://stackoverflow.com/a/3368118/1054633
 */
export function roundedRectangle(ctx, x, y, width, height, radius, fill, stroke) {
